...
| **Market Sentiment** | **All-A Turnover Year-on-Year Growth**   | AkShare     | **From negative to positive + consecutive monthly increase**: Sentiment recovery (confirm stage 2)**>50% and accelerating**: Sentiment overheating (warning stage 4 top)**< -20%**: Sentiment ice point (stage 5-6, left-side opportunity) |
